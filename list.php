...
<html lang="en">
  <head>
    ...
    <title>List Total Per Negara</title>
  </head>
  <body>
    <div class="container">
        <div class="row">
            <div class="col-12">
            <h2>LIST TOTAL PER NEGARA</h2>
                ...
                <table class="table table-dark" id="list">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $key["TotalConfirmed"]; ?></td>
                            <td><?php echo $key["TotalDeaths"]; ?></td>
                            <td><?php echo $key["TotalRecovered"]; ?></td>
                        </tr>
                    </tbody>
                    <?php endforeach; ?>
                </table>
